...
This project is using the already existing [**cookie-based session authentication**](https://docs.djangoproject.com/en/4.1/topics/auth/default/#how-to-log-a-user-in) in Django:
...
1. <https://docs.djangoproject.com/en/4.1/ref/settings/#sessions> - It's a good idea to just read every description for `SESSION_*`
...
1. The so-called "direct" upload that can work both locally and with S3.
